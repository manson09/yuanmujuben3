...
export const generateScriptSegment = async (
  ...
  const prompt = `
    ...
    7. **禁止辞藻堆砌**
    8. **模仿大学生/新派网文口吻**：语言要直白、干脆、甚至带点“碎”。多用短句，少用排比句。
...
4. **视觉关联**：所有人物动作必须锚定身份，让导演和演员一眼看出是谁在推动剧情。
    ...
    【极致爽感渲染引擎 (High-Tension "Shuang" Engine)】：
1. **压迫感升级**：不要写“金光消逝”，要写“金光刺破重云，带起的恐怖余威让方圆百里草木瞬间枯萎，众生如芒在背”。
2. **动作张力**：多用具有毁灭性的动词。例如：“撕裂”、“炸响”、“震碎”、“跪伏”。
3. **降维打击**：描写主角或大人物时，要侧面烘托其无敌感。例如：“李云仅仅是一个眼神，周围空气便凝固成冰，让所有暗卫动弹不得”。
4. **情绪钩子**：台词要狂、要冷、要有逼格。
